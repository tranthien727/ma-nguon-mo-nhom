...
<?php include '../Admin/partials/header.php'; ?>
    ...
    <form action="" method="post">
        <table align="center" bgcolor="#faebd7">
            ...
            <tr>
                <td>Diện tích</td>
                <td> <input type="text" name="area" style="background-color: lightpink; width: 150px" readonly value="<?php if (isset($s)) echo $s;
                                                                                                                        else echo ""; ?>">
                </td>
            </tr>
            <tr>
                <td>Chu vi</td>
                <td> <input type="text" name="chuvi" style="background-color: lightpink; width: 150px" readonly value="<?php if (isset($p)) echo $p;
                                                                                                                        echo ""; ?>">
                </td>
            </tr>
            <tr>
