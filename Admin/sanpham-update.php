...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "UPDATE `sanpham` SET`Tensp`='$name',`Giatien`='$giatien',`Soluong`='$soluong',`Thesim`='$thesim',
        `Bonhotrong`='$bonho',`Ram`='$ram',`Anhbia`='$anh',`Mahang`='$hang',`Mahdh`='$hdh' WHERE Masp=$Masp";
