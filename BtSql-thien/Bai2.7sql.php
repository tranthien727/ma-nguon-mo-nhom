            ...
            <?php include '../Admin/navigation.php'; ?>
                ...
                <?php
                    ...
                    <table align="center" border="1">
                        ...
                        $query="SELECT `sua`.`Ma_sua`,`sua`.`Hinh`,`sua`.`Ten_sua`, `sua`.`Trong_luong`, `sua`.`Don_gia`, `hang_sua`.`Ten_hang_sua`, `loai_sua`.`Ten_loai` 
                        ...
                        if ($result == true) {
                            ...
                            while ($rows = mysqli_fetch_array($result)) {
                                ...
                                echo "<td><b>";
                                ?>
                                <a href='Bai2.7sql-view.php?id=<?php echo $rows["Ma_sua"]; ?>'><?php echo  $rows["Ten_sua"]; ?></a></b>
                                <?php
